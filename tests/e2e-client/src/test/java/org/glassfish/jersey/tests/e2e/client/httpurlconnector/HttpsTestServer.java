...
/**
 * Simple HTTPS server for testing concurrent SSL connections.
 * <p>
 * Backported from Jersey 3.x PR #5794
 */
class HttpsTestServer implements Runnable {
    private final SSLServerSocket sslServerSocket;
    private boolean closed = false;

    public HttpsTestServer(SSLContext context) throws Exception {
